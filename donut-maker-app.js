...
function makeDonuts(){
  ...
  const donutMaker = new DonutMaker(0, 0, 1, 5, 20);
  ...
  donutBtn.addEventListener('click', ()=>{
    ...
    costTillMulti.innerText = (donutMaker.multiplierPrice - donutMaker.donutCount) + ' More donuts to buy a Multiplier'
    ...
    console.log('auto price is ' + donutMaker.autoClickPrice);
    console.log('multi price is ' + donutMaker.multiplierPrice);    
  });
  });
